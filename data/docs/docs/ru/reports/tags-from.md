> Источник: https://yandex.ru/support/metrica/ru/reports/tags-from
# Отчет «Метки From»

- [Какие задачи может решать отчет](ru/reports/tags-from#case)
- [Структура и настройки отчета](ru/reports/tags-from#data)
- [Узнайте больше](ru/reports/tags-from#uznajte-bolshe)

Отчет содержит статистику по *метке* `from`, если вы используете ее в ссылках на свой сайт.

Посмотреть отчет: **Отчеты** → **Источники** → **Метки From**.

## ru/reports/tags-from#caseКакие задачи может решать отчет

Метки помогают более точно отслеживать источники трафика на сайт. Например, если вы разместили на другом ресурсе несколько ссылок на свой сайт, их можно различить по значениям метки `from`:

```
https://source-example.com/partner/offer/
#раздел, в котором размещается первая ссылка
https://example.com/?from=source-example-offer
#первая ссылка на ваш сайт

https://source-example.com/partner/about/
#раздел, в котором размещается вторая ссылка
https://example.com/?from=source-example-about
#вторая ссылка на ваш сайт
```

## ru/reports/tags-from#dataСтруктура и настройки отчета

Информация в отчете сгруппирована по значению метки `from`. Отчет поддерживает [все настройки](ru/reports/report-general), доступные в Яндекс Метрике.

## ru/reports/tags-from#uznajte-bolsheУзнайте больше
