> Источник: https://yandex.ru/support/metrica/ru/reports/tags
# О группе отчетов «Метки»

*Метки* помогают отслеживать [источники переходов на сайт](ru/sources/sources-summary). Метка может состоять из одного или нескольких параметров, которые добавляются в URL. Это позволяет отслеживать переходы по конкретной ссылке.

[Как Яндекс Метрика обрабатывает метки](ru/general/source-tags)

В группу входят:

- [Отчет «Метки From»](ru/reports/tags-from)
- [Отчет «Метки UTM»](ru/reports/tags-utm)
- [Отчет «Метки Openstat»](ru/reports/tags-openstat)

Чтобы отслеживать переходы с рекламных объявлений Яндекс Директа, используйте следующие отчеты:

- [Директ, сводка](ru/sources/direct-summary)
- [Директ, площадки](ru/sources/direct-sites)
- [Директ, расходы](ru/sources/direct-clicks)

Для отслеживания других рекламных объявлений используйте отчет [Рекламные системы](ru/reports/ad-systems).

## ru/reports/tags#uznajte-bolsheУзнайте больше
