> Источник: https://yandex.ru/support/metrica/ru/reports/tags-utm
# Отчет «Метки UTM»

- [Какие задачи может решать отчет](ru/reports/tags-utm#case)
- [Структура и настройки отчета](ru/reports/tags-utm#data)
- [Узнайте больше](ru/reports/tags-utm#uznajte-bolshe)
- [Вопросы и ответы](ru/reports/tags-utm#qanda)

Отчет содержит статистику по *метке* `UTM`, если вы используете ее в ссылках на свой сайт.

Посмотреть отчет: **Отчеты** → **Источники** → **Метки UTM**.

## ru/reports/tags-utm#caseКакие задачи может решать отчет

Яндекс Метрика использует UTM-метки для [определения многих источников трафика](ru/general/sources-tracking) и формирует для некоторых из них специальные отчеты, например, по переходам из мессенджеров или социальных сетей.
...
#первая ссылка на ваш сайт

https://source-example.com/partner/about/
#раздел, в котором размещается вторая ссылка
https://example.com/?utm_source=link&utm_medium=source-example&utm_campaign=partner-about
#вторая ссылка на ваш сайт
```

Чтобы данные отобразились в отчете, важно [правильно сформировать метку](ru/general/source-tags#utm-construct).

## ru/reports/tags-utm#dataСтруктура и настройки отчета

Информация в отчете сгруппирована по паре «атрибут-значение» метки. Отчет поддерживает [все настройки](ru/reports/report-general#set-report), доступные в Яндекс Метрике.

## ru/reports/tags-utm#uznajte-bolsheУзнайте больше
...
## ru/reports/tags-utm#qandaВопросы и ответы
